...
gulp.task('sass',function () {
    gulp.src(app.srcPath+'style/index.sass')
        .pipe(sass())
 ...
 * */
gulp.task('build',['sass','html','js','image','lib']);
...
gulp.task('server',['build'],function () {
    ...
    /*监听哪些任务*/
    gulp.watch('bower_components/**/*',['style']);
    gulp.watch(app.srcPath+'**/*.html',['html']);
    gulp.watch(app.srcPath+'js/**/*.js',['js']);
    gulp.watch(app.srcPath+'images/**/*',['image']);
    gulp.watch(app.srcPath+'style/**/*.sass',['sass']);

    //通过浏览器把指定的地址 （http://localhost:8010）打开。
