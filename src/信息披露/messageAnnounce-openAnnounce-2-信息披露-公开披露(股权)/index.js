$(function(){
    ...
    $(".sure_rate").click(function(){
        $(".rate_box").hide();
        $(".pre_table").append('<tr><td>'+$(".rate_box input").eq(0).val()+'</td><td>'+$(".rate_box input").eq(3).val()+'</td><td>'+$(".rate_box input").eq(4).val()+'</td><td>'+$(".rate_box select").eq(0).find("option:selected").text()+'</td><td>'+$(".rate_box input").eq(1).val()+'</td><td><span class="look">查看</span><span class="edit">编辑</span><span class="delete" onclick="removeFn(this)">删除</span></td></tr>');
    });
