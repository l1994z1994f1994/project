$(function(){
	...
	$(".add_ques").click(function(){
        ...
        $(".tbody").append('<tr class="question_num"><td>题号'+length+'</td><td>单选</td><td><span class="preview" onclick="unfoldFn(this)">展开<img src="../commons/image/xiangyou02.png"></span><span class="delete" onclick="deleteFn(this)">删除</span><span class="save" onclick="saveFn(this)">保存</span><span class="canc" onclick="cancelFn(this)">取消</span></td></tr>');
        $(".tbody").append('<tr class="table_tr"><td colspan="3" class="cols_pan"><table class=" table_text"><tbody class="table_body"><tr><td style="width: 34%">问卷标题：<input type="text" name="" class="quest_con" maxlength="100"></td><td style="width: 33%">问题选项：<span class="add_option" onclick="addFn(this)">+添加内容</span></td><td></td></tr><tr class="operate_title"><td>选项内容：</td><td>选项分数：</td><td>操作</td></tr><tr><td><input type="text" name="" placeholder="请输入内容" maxlength="100"></td><td><input type="text" name=""></td><td><span class="move_up" onclick="moveupFn(this)">上移</span><span class="move_down" onclick="movedownFn(this)">下移</span><span class="remove" onclick="deleteFn(this)">删除</span></td></tr></tbody></table></td></tr>');
	});
...
function moveupFn(el){
	if(!$(el).parent().parent().prev().hasClass("operate_title")){
