...
function addChange(el){
   ...
   $(".cert_hand").click(function(){
        $(".handle_box").hide();
        $(el).parent().find(".change_name").remove();
        $(".right_li span").each(function(index){
           ...
           if(sole == 1){
                ...
                $(".change_add").before('<span class="change_name">'+text+'<img src="../commons/image/reset.png" style="width:14px;" onclick="resetFn(this)"></span>');
           }
        });
    });
}
