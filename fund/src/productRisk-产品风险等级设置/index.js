$(function(){
    ...
    $(".add").click(function(){
        ...
        $("tbody").append('<tr><td>R'+length+'</td><td class="risk_grade"><input type="text" placeholder="请输入"></td><td class="com_invest"><textarea placeholder="请输入"></textarea></td><td><span class="sure" onclick="editFn(this)">保存</span><span class="delete" onclick="deleteFn(this)">删除</span></td></tr>');
    });
});
function editFn(el){
    if($(el).text() == "编辑"){
